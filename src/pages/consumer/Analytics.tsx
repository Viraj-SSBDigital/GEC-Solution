  ...
  return (
    <Layout>
      <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-gray-900 dark:text-white">
                  {formatEnergy(metrics.totalGreenEnergy)}
                </p>
        ...
        {/* Monthly Green Energy Line Chart */}
        <Card className="dark:bg-gray-900 dark:border-gray-700">
          <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4">
            Monthly Green Energy Consumption
          </h3>
        ...
        {/* Impact Summary and Environmental Equivalents */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Card className="bg-gradient-to-br from-emerald-500/10 to-cyan-500/10 border border-emerald-500/20 dark:bg-gray-900 dark:border-gray-700">
          ...
          <Card className="bg-gradient-to-br from-blue-500/10 to-cyan-500/10 border border-blue-500/20 dark:bg-gray-900 dark:border-gray-700">
            <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between">
                ...
                <span className="text-cyan-400 font-semibold">
                  {Math.floor(metrics.co2Saved / 4.6)}
                </span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-500 dark:text-gray-400">
                ...
                <span className="text-blue-400 font-semibold">
                  {Math.floor(metrics.totalGreenEnergy / 30)}
                </span>
              </div>
            </div>
          </Card>
