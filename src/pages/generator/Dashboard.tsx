      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-gray-500 dark:text-gray-400">
            {generatorInfo?.name || "Generator Portal"}
          </p>
        </div>

        {/* Generator Info */}
        {generatorInfo && (
          <Card className="bg-gradient-to-r from-amber-500/20 to-orange-500/20 border border-amber-500/30 dark:bg-gradient-to-r dark:from-amber-500/30 dark:to-orange-500/30 dark:border-amber-500/40">
        ...
        {/* Recent Tokens and Allocation Status */}
          ...
          <Card className="dark:bg-gray-900 dark:border-gray-700">
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="w-full bg-gray-200/20 dark:bg-gray-800 rounded-full h-3 overflow-hidden">
                  <div
              ...
              <div className="grid grid-cols-2 gap-4 pt-4 border-t border-gray-700 dark:border-gray-600">
                <div>
                  <p className="text-gray-500 dark:text-gray-400 text-sm mb-1">
                    Available
                  </p>
                  <p className="text-gray-900 dark:text-white font-semibold">
                    {
                      generatorTokens.filter((t) => t.status === "generated")
                        .length
                    }
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-emerald-400 font-semibold">
                    {
                      generatorTokens.filter((t) => t.status === "allocated")
                        .length
                    }
                  </p>
                </div>
